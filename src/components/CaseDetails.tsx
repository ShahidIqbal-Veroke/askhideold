...
export const CaseDetails: React.FC<CaseDetailsProps> = ({
    ...
    return (
        <div className="space-y-2">
            <Card className="h-[calc(100vh-350px)] border-3xl rounded-[20px]">
                <CardHeader className="rounded-[20px]">
                ...
                <CardContent className="max-h-[calc(100%-120px)] overflow-y-auto">
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-2 space-y-2 text-sm">
                                            ...
                                            <div className="flex justify-between">
                                                ...
                                                <span>{caseItem?.case_type || 'Unknown'}</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-2 space-y-2 text-sm">
                                            <div className="flex justify-between">
                                                ...
                                                <span>{caseItem.assigned_to || 'Accidental Claim'}</span>
                                            </div>
                                            <div className="flex justify-between">
                                        ...
                                        <div className="mt-2 space-y-1 text-sm">
                                            ...
                                            <div className="flex justify-between items-center">
                                                ...
                                                <a
                                                    ...
                                                    onClick={(e) => {
                                                        e.preventDefault();
                                                        // TODO: Add actual attachment download/view logic
                                                    }}
            ...
            <Card className="rounded-[20px]">
                <CardContent className="flex flex-col gap-2 pt-4 rounded-[20px]">
                    <div className="flex items-center justify-between">
